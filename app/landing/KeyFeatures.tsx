        ...
        <div className="-mx-4 flex flex-wrap p-8">
                ...
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
                    ...
                    <div>
                        ...
                        <p className="text-base font-medium text-body-color">
                            Discover secret concerts, pop-up markets, and underground events in your city—curated from local sources you won't find anywhere else.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9 ">
                    ...
                    <div>
                        ...
                        <p className="text-base font-medium text-body-color">
                            Book your spot and get navigation in a single click—no more juggling between apps.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
                    <div className="mx-auto mb-7 inline-block"><svg width="67" height="60" viewBox="0 0 67 60"
                        ...
                        <rect x="39.8958" y="47.666" width="24.6688" height="11.3344" rx="2"
                            fill="white" stroke="#6A64F1" strokeWidth="2"></rect>
                        <rect x="21" y="18" width="45" height="10" rx="2"
                            fill="white" stroke="#6A64F1" strokeWidth="2">
                        </rect>
                    </svg></div>
                    <div>
                        <h3 className="mb-4 text-xl font-bold sm:text-2xl lg:text-xl xl:text-2xl">
                        ...
                        <p className="text-base font-medium text-body-color">
                            See events matched to your tastes (music, art, food) so you spend less time searching and more time enjoying.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
                    <div className="mx-auto mb-7 inline-block"><svg width="58" height="60" viewBox="0 0 58 60"
                        ...
                        <rect x="1" y="1" width="24" height="26" rx="2"
                            stroke="#6A64F1" strokeWidth="2"></rect>
                        <path
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M31 10.5H26V8.5H31V10.5Z" fill="#6A64F1">
                        </path>
                        <path fillRule="evenodd" clipRule="evenodd" d="M31 47H26V45H31V47Z" fill="#ABA8F7"></path>
                        <path fillRule="evenodd" clipRule="evenodd" d="M14 28L14 33L12 33L12 28L14 28Z"
                            fill="#6A64F1">
                        </path>
                        <defs>
                    ...
                    <div>
                        <h3 className="mb-4 text-xl font-bold sm:text-2xl lg:text-xl xl:text-2xl">
                            Last-Minute Plans? Sorted
                        </h3>
                        <p className="text-base font-medium text-body-color">
                            Find great events happening tonight with real-time updates and last-minute ticket deals.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
                    ...
                    <div>
                        <h3 className="mb-4 text-xl font-bold sm:text-2xl lg:text-xl xl:text-2xl">
                            Group Plans Made Easy
                        </h3>
                        <p className="text-base font-medium text-body-color">
                            Invite friends, vote on events, and split costs—all in one place. No more endless group chats.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
                    ...
                    <div>
                        <h3 className="mb-4 text-xl font-bold sm:text-2xl lg:text-xl xl:text-2xl">
                            Double Points for Weeknights
                        </h3>
                        <p className="text-base font-medium text-body-color">
                            Earn rewards (free tickets, upgrades) for attending off-peak events.
                        </p>
                    </div>
                </div>
            </div>
